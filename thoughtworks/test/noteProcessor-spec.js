QUnit.module("noteProcessor", function(hooks){
   ...
   QUnit.test("UNIT: respondToHowMany() returns an error message if the input array is empty", function(assert){
      var wordsAfterIs = [];
      var result = noteProcessor._respondToHowMany(wordsAfterIs);
   ...
   QUnit.test("UNIT: isValidRomanNumeralString() returns a boolean value of true if the input string is valid", function(assert){
